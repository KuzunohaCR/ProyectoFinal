...
CREATE TABLE `listareproduccion` (
  ...
  `idnoadmin` int NOT NULL,
  PRIMARY KEY (`idlistareproduccion`),
  KEY `idnoadmin_listareproduccion_idx` (`idnoadmin`),
  CONSTRAINT `idnoadmin_listareproduccion` FOREIGN KEY (`idnoadmin`) REFERENCES `noadmin` (`idnoadmin`)
...
INSERT INTO `listareproduccion` VALUES (1,'Entrenamiento',1,'2020-12-11',1),(2,'Entrenamiento',4,'2020-12-19',4),(3,'Cumbion Loco',5,'2020-12-19',1);
...
-- Dump completed on 2020-12-19 22:22:47
